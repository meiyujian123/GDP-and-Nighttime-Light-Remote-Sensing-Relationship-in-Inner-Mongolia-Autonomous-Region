...
//ol.proj.get("EPSG:4326").setExtent([97.171720, 37.406647, 126.065581, 53.333779]);
var wms_layers = [];
...
lyr__railways_2.set('fieldLabels', {'osm_id': 'inline label - always visible', 'code': 'no label', 'fclass': 'no label', 'name': 'no label', 'layer': 'no label', 'bridge': 'no label', 'tunnel': 'no label', });
